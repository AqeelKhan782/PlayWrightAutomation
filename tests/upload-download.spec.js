...
test('Upload download excel validation', async ({ page }) => {
    ...
    const filePath = '/Users/mac/Downloads/download.xlsx'; // or await dl.path()
...
/*
 1. Here we are doing excel reading, writing and updating.
 2. How to handle upload and download in playwright.
 3. How we will wait for download.
 4. How to scan and filter table data.
 */